...
function centric_enqueue_home_scripts() {
	...
	wp_enqueue_script( 'zalo-home-js', get_bloginfo( 'stylesheet_directory' ) . '/js/home.js', array( 'jquery' ), '1.1.0', true );
...
function centric_home_featured_widget() {
	...
	genesis_widget_area( 'home-widgets-1', array(
		'before' => '<div id="home" class="home-featured"><div class="white"><div class="wrap"><div class="home-widgets-1 color-section widget-area">',
...
function centric_home_widgets() {
	...
	genesis_widget_area( 'about-us-widgets', array(
		'before' => '<div id="about-us" class="about-us-widgets widget-area">',
		'after'  => '</div>',
	) );

	genesis_widget_area( 'contact-us-widgets', array(
		'before' => '<div id="contact-us" class="contact-us-widgets color-section widget-area contact-us">',
		'after'  => '</div>',
	) );
