...
function centric_load_scripts() {
	...
	wp_enqueue_script( 'zalo-imagesloaded', get_bloginfo( 'stylesheet_directory' ) . '/js/imagesloaded.js', array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'zalo-global-js', get_bloginfo( 'stylesheet_directory' ) . '/js/global.js', array( 'jquery' ), '1.1.0', true );
